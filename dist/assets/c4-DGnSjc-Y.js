import{A as e,a as t,d as n,f as r,i,l as a,lt as o,mt as s,n as c,o as l,p as u,pt as d,r as f,rt as p,t as m,tt as h,u as g}from"./c1-YQs-8ydn.js";import{n as _,t as ee}from"./c2-Bcatdvtc.js";function te(e){!e||e._fallbackApplied||(e._fallbackApplied=!0,e.classList.add(`fallback-logo`),e.src=document.body.classList.contains(`theme-upbit`)?`/static/luma-deer-svg-light.svg`:`/static/luma-deer-svg-dark.svg`)}window.handleLogoError=te,window.addEventListener(`error`,e=>{if(e.target&&e.target.tagName===`IMG`){let t=e.target;(t.src.includes(`coinmarketcap.com/static/img/coins`)||t.closest(`.col-asset`)||t.closest(`#head-asset-name`))&&te(t)}},!0);function ne(){try{if(d.originalTableData&&d.originalTableData.length>0)return;let e=localStorage.getItem(`sellnance_market_data_cache`);if(!e)return;let t=JSON.parse(e);if(!t||!Array.isArray(t.data)||t.data.length===0)return;d.originalTableData=t.data,(!d.currentTableData||d.currentTableData.length===0)&&(d.currentTableData=t.data),d.tickerRowMap&&t.data.forEach(e=>{if(!e)return;let t=e.UID?String(e.UID):null,n=e.Symbol?String(e.Symbol).toUpperCase():null,r=e.DisplayTicker?String(e.DisplayTicker).toUpperCase():null,i=e.Ticker?String(e.Ticker).toUpperCase():null;t&&d.tickerRowMap.set(t,e),n&&!d.tickerRowMap.has(n)&&d.tickerRowMap.set(n,e),r&&!d.tickerRowMap.has(r)&&d.tickerRowMap.set(r,e),i&&!d.tickerRowMap.has(i)&&d.tickerRowMap.set(i,e)})}catch(e){console.warn(`로컬 캐시 선제 동기화 실패:`,e)}}window.preloadCachedMarketData=ne;function re(){try{if(ne(),u(),localStorage.getItem(`sellnance_sidebar_collapsed`)===`true`){d.isSidebarOpen=!1;let e=document.getElementById(`left-panel`);e&&(e.classList.remove(`md:flex`),e.classList.add(`md:hidden`));let t=document.getElementById(`sidebar-toggle-text`);t&&(t.innerText=`▶ 펼치기`)}if(localStorage.getItem(`sellnance_header_collapsed`)===`true`){let e=document.getElementById(`head-asset-row`),t=document.getElementById(`head-info-row`),n=document.getElementById(`head-badges-row`),r=document.getElementById(`toggle-header-top-btn`);[e,t,n].forEach(e=>{e&&(e.style.display=`none`,e.classList.add(`hidden`))}),r&&(r.innerText=`▼ 헤더 펼치기`)}let e=localStorage.getItem(`sellnance_panel_swapped`)===`true`;if(document.documentElement.classList.toggle(`panel-swapped-mode`,e),e){let e=document.getElementById(`panel-split-container`),t=document.getElementById(`left-panel`);e&&(e.style.setProperty(`flex-direction`,`row-reverse`,`important`),e.classList.remove(`flex-row`,`md:flex-row`),e.classList.add(`panel-swapped`,`flex-row-reverse`)),t&&(t.style.borderRightWidth=`0px`,t.style.borderLeftWidth=`1px`)}let t=localStorage.getItem(`sellnance_table_view_mode`);if(!t||t===`simple`){t=`basic`;try{localStorage.setItem(`sellnance_table_view_mode`,`basic`)}catch{}}typeof l==`function`&&l(t,!1),typeof window.restoreControlPanelUI==`function`&&window.restoreControlPanelUI(),typeof window.updateCandleThemeButtons==`function`&&window.updateCandleThemeButtons(),typeof window.updateSortUI==`function`&&window.updateSortUI(d.currentSortCol,d.sortState)}catch{}}var v=null;function y(){return v||(v=(async()=>{re(),typeof window.restoreControlPanelUI==`function`&&window.restoreControlPanelUI(),typeof ee==`function`&&ee();try{typeof window.initChart==`function`?await window.initChart():typeof a==`function`&&await a(),await Promise.all([i(),h()]),d.currentTableData&&d.currentTableData.length>0&&(f(),m(),c(),typeof window.initInfiniteScroll==`function`&&window.initInfiniteScroll(),typeof window.initAllExchangeFeeds==`function`&&window.initAllExchangeFeeds(),d.isEngineStarted=!0,_())}catch(e){console.error(`Dashboard engine init error:`,e)}})(),v)}window.initDashboardEngine=y;function b(){let e=document.getElementById(`status-timer`),t=document.getElementById(`status-users`),n=document.getElementById(`tooltip-timer`),r=document.getElementById(`tooltip-users`),i=document.getElementById(`status-tooltip-text`),a=document.getElementById(`status-timer-dot`),o=d.activeUsers||1;if(t&&(t.innerText=`${o} Active`),r&&(r.innerText=`${o} Active`),!d.lastUpdatedRaw&&!d.nextUpdateRaw){e&&(e.innerText=`--:-- 이후 갱신`),n&&(n.innerText=`--:--`);return}let s=Math.floor(Date.now()/1e3),c=localStorage.getItem(`CMC_API_KEY`)&&localStorage.getItem(`CMC_API_KEY`).trim()!==``,l=0;if(d.nextUpdateRaw)l=Math.floor(d.nextUpdateRaw-s);else if(d.lastUpdatedRaw){let e=c?900:14400,t=Math.floor(d.lastUpdatedRaw)+e;l=Math.floor(t-s)}else{e&&(e.innerText=`--:-- 이후 갱신`),n&&(n.innerText=`--:--`);return}if(l<=0){let t=`대기 중...`;e&&(e.innerText=t),n&&(n.innerText=t);let r=Date.now();(!d._lastAutoSilentFetch||r-d._lastAutoSilentFetch>1e4)&&(d._lastAutoSilentFetch=r,typeof window.loadTableDataSilent==`function`&&window.loadTableDataSilent());return}let u=`<svg class="inline-block w-3 h-3 mr-1 align-middle text-theme-text opacity-75" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><line x1="12" y1="8" x2="12" y2="12"></line><line x1="12" y1="16" x2="12.01" y2="16"></line></svg>`,f=Math.floor(l/3600),p=Math.floor(l%3600/60),m=`${f.toString().padStart(2,`0`)}:${p.toString().padStart(2,`0`)}`;c?d.cmcStatus===`INVALID_KEY`?(e&&(e.innerHTML=`${u}${m} (키 오류)`,e.title=`CMC API 키 오류 (서버 정기 캐시 유지)`,e.style.cursor=`default`),n&&(n.innerHTML=`<span class="text-rose-400 font-bold">⚠️ CMC API 키 오류</span>`),i&&(i.innerHTML=`<span class="text-rose-400 font-bold">입력하신 개인 CMC API 키가 유효하지 않아요</span><br/>실시간 시세 및 차트는 정상 작동하며, 시가총액은 서버 캐시로 안전하게 유지할게요<br/><span class="text-xs opacity-75 text-theme-accent">설정에서 유효한 키인지 다시 확인해 주세요</span>`),a&&(a.className=`inline-block w-2 h-2 min-[1200px]:w-1.5 min-[1200px]:h-1.5 rounded-full bg-rose-500 animate-pulse`)):(e&&(e.innerText=`${m} 이후 갱신`,e.title=``,e.style.cursor=`default`),n&&(n.innerHTML=`<svg class="inline-block w-3.5 h-3.5 mr-1 align-middle text-theme-text opacity-85" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline></svg>${m} 남음 (15분 주기)`),i&&(i.innerHTML=`개인 CMC API 키 연동 완료 <svg class="inline-block w-3.5 h-3.5 ml-1 align-middle text-theme-text opacity-85" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2c.71-.84.7-2.13-.09-2.91a2.18 2.18 0 0 0-2.91-.09z"></path><path d="m12 15-3-3a22 22 0 0 1 2-3.95A12.88 12.88 0 0 1 22 2c0 2.72-.78 7.5-6 11a22.35 22.35 0 0 1-4 2z"></path></svg><br/>15분 주기로 시총이 자동 갱신됩니다.`),a&&(a.className=`inline-block w-2 h-2 min-[1200px]:w-1.5 min-[1200px]:h-1.5 rounded-full bg-emerald-500 animate-pulse`)):(e&&(e.innerHTML=`${u}${m} (정기 캐시)`,e.title=``,e.style.cursor=`default`),n&&(n.innerHTML=`${u}${m} (정기 캐시)`),i&&(i.innerHTML=`개인 CMC API 키 미입력 상태에요<br/>서버 정기 캐시 모드(4시간 주기)로 시총을 갱신할게요`),a&&(a.className=`inline-block w-2 h-2 min-[1200px]:w-1.5 min-[1200px]:h-1.5 rounded-full bg-amber-400 animate-pulse`))}function ie(e){if(e&&e.stopPropagation(),window.innerWidth<1200){let e=document.getElementById(`mobile-chart-overlay`);if(e&&e.style.opacity===`1`&&!e.classList.contains(`hidden`)||window.store&&window.store._currentMobileTab===`chart`)return}let t=document.getElementById(`status-cache-tooltip`);t&&(t.classList.contains(`opacity-100`)?(t.classList.remove(`opacity-100`,`pointer-events-auto`,`translate-y-0`),t.classList.add(`opacity-0`,`pointer-events-none`,`translate-y-1`)):(b(),t.classList.remove(`opacity-0`,`pointer-events-none`,`translate-y-1`),t.classList.add(`opacity-100`,`pointer-events-auto`,`translate-y-0`)))}typeof document<`u`&&document.addEventListener(`click`,e=>{if(window.innerWidth<1200){let t=document.getElementById(`server-status-badge`),n=document.getElementById(`status-cache-tooltip`);n&&n.classList.contains(`opacity-100`)&&(!t||!t.contains(e.target))&&(n.classList.remove(`opacity-100`,`pointer-events-auto`,`translate-y-0`),n.classList.add(`opacity-0`,`pointer-events-none`,`translate-y-1`))}}),window.toggleStatusTooltip=ie,window.updateStatusBadge=b;function x(){if(!d.bypassCounters)return;let e=Object.values(d.bypassCounters).reduce((e,t)=>e+t,0),t=document.getElementById(`perf-total-bypass`);t&&(t.innerText=`Total: ${e}`),[`leftDom`,`tabScroll`,`tableUpdate`,`kimchi`,`radarBatch`,`mouseEvent`,`dynamicHtml`,`throttleBypass`,`throttlePass`].forEach(e=>{let t=document.getElementById(`bypass-cnt-${e}`);t&&(t.textContent=d.bypassCounters[e]||0)});let n=document.getElementById(`perf-top-risk-analysis`);if(n){let e=-1,t=`NONE`;Object.entries(d.bypassCounters).forEach(([n,r])=>{r>e&&(e=r,t=n)}),e===0?(n.innerText=`안정 (소켓 수급 정체 혹은 렉 유발 없음)`,n.className=`text-[8.5px] font-semibold text-emerald-400 opacity-90 leading-tight bg-white/2 p-1 rounded font-sans`):(n.innerText=`⚠️ ${{leftDom:`좌측 테이블 DOM 최적화 차단`,chartDom:`우측 차트 렌더러 지연 차단`,orderbook:`실시간 호가창 렌더링 락`,legend:`상단 가격 레전드 문자열 덮어쓰기`,resize:`차트 리사이즈 오버헤드`,mouseEvent:`차트 십자선 마우스 이벤트 지연`,sort:`테이블 실시간 순위 재배치 루프`,tabScroll:`테이블 전체 리렌더링 리플로우`,tableUpdate:`개별 행 셀 텍스트 갱신 과부하`,kimchi:`3초 주기 김프 연산 전파 루프`,radarBatch:`3초 레이더 일괄 갱신 차단`,dynamicHtml:`김프 전파 HTML 동적 렌더링 과부하`}[t]||t} (${e}회 Bypass)`,n.className=`text-[8.5px] font-semibold text-rose-400 opacity-90 leading-tight bg-white/2 p-1 rounded font-sans`)}}window.updatePerformanceDebugger=x;var S=null,C=null;function ae(){S&&clearInterval(S),C=Date.now(),d.bypassCounters&&Object.keys(d.bypassCounters).forEach(e=>{d.bypassCounters[e]=0});let e=document.getElementById(`perf-run-time-display`);e&&(e.innerText=`(0s 경과)`),x(),S=setInterval(()=>{if(C){let e=Math.floor((Date.now()-C)/1e3),t=document.getElementById(`perf-run-time-display`);t&&(t.innerText=`(${e}s 경과)`)}x()},1e3)}window.startPerformanceDebugger=ae;function oe(){S&&=(clearInterval(S),null)}window.stopPerformanceDebugger=oe;function w(){let e=window.location.pathname.replace(/^\/+|\/+$/g,``);return e&&![`api`,`static`,`assets`,`index.html`,`favicon.ico`].includes(e.toLowerCase())?decodeURIComponent(e):window.location.hash&&window.location.hash.length>1?decodeURIComponent(window.location.hash.substring(1)):null}window.getInitialRouteSymbol=w;function se(){let e=new Date,t=new Date;t.setUTCHours(0,0,0,0),e>=t&&t.setUTCDate(t.getUTCDate()+1);let n=t.getTime()-e.getTime();setTimeout(()=>{let e=d.marketDataMap?.krw_usd_rate||0;d.currentTableData&&Array.isArray(d.currentTableData)&&(d.currentTableData.forEach(t=>{(t.Binance_Price_Futures||t.Price_Raw)&&(t.futures_utc0_open_Raw=t.Binance_Price_Futures||t.Price_Raw),(t.Binance_Price_Spot||t.Price_Raw)&&(t.spot_utc0_open_Raw=t.Binance_Price_Spot||t.Price_Raw),(t.Price_KRW||t.Price_Raw&&e>0)&&(t.utc0_open_KRW=t.Price_KRW||t.Price_Raw*e),t.Price_Raw&&(t.utc0_open_Raw=t.Price_Raw),t.Change_Today_Raw=0,t.Change_Today_Futures=0,t.Change_Today_Spot=0,t.Change_Today_Binance=0,t.Change_Today_Upbit=0,t.Change_Today_Bithumb=0,t.Change_Today_Bybit=0}),typeof window.renderTable==`function`&&window.renderTable()),d.currentAsset&&typeof window.selectSymbol==`function`&&window.selectSymbol(d.currentAsset),setTimeout(()=>{typeof window.loadTableData==`function`&&window.loadTableData(!0,!0)},2e3),se()},n)}function ce(){try{let e=localStorage.getItem(`sellnance_last_tf`);e&&[`1m`,`3m`,`5m`,`15m`,`30m`,`1h`,`4h`,`12h`,`1d`,`3d`,`1w`,`1M`].includes(e)&&(d.currentTF=e)}catch{}let e=w();if(e&&d.isEngineStarted)typeof t==`function`&&t(e);else if(window.innerWidth<1200)try{(sessionStorage.getItem(`sellnance_active_mobile_tab`)||`list`)===`chart`&&typeof switchMobileTab==`function`&&switchMobileTab(`chart`)}catch{}let n=()=>{let e=w();e&&d.isEngineStarted&&typeof t==`function`&&t(e)};window.addEventListener(`popstate`,n),window.addEventListener(`hashchange`,n)}function le(){let e=0,t=()=>{if(typeof document<`u`&&document.visibilityState!==`visible`)return;let t=e>0?Date.now()-e:0;typeof window.flushRealtimeRender==`function`&&window.flushRealtimeRender(),typeof window.refreshSniperTarget==`function`&&window.refreshSniperTarget(),t>10*1e3&&d.currentAsset&&d.candleSeries&&!d.isFetchingChart&&!d.isSilentSyncing&&typeof window.fetchHistory==`function`&&window.fetchHistory(d.currentAsset,!1,!1,!1,d.currentUid,!0),t>30*1e3&&(typeof window.syncSniperSubscriptions==`function`&&window.syncSniperSubscriptions(),typeof window.initAllExchangeFeeds==`function`&&window.initAllExchangeFeeds(),typeof window.loadTableDataSilent==`function`?window.loadTableDataSilent():typeof window.loadTableData==`function`&&window.loadTableData(!1,!0)),e=0};typeof document<`u`&&document.addEventListener(`visibilitychange`,()=>{document.visibilityState===`hidden`?e=Date.now():document.visibilityState===`visible`&&t()}),typeof window<`u`&&window.addEventListener(`focus`,()=>{e>0&&t()})}var T={cycleIntervalMs:3e3,goldenRatio:`1.618 / 1`,deckWidth:`100%`,deckMaxWidth:`800px`,compassCycle:[`NW`,`NE`],tiltAngle:[5,5,-5,-5],scale:1,perspective:1200,exitDurationMs:200,auraInset:`0px`,auraBorderRadius:`20px`,auraBlur:`14px`,auraOpacity:.07,auraBackground:`radial-gradient(ellipse at center, var(--accent) 0%, transparent 60%)`,auraBoxShadow:`0 0 12px var(--accent)`},E=[{layout:`spread`,tf:`4h`,candleMode:`unique`},{layout:`overlap`,tf:`1d`,candleMode:`unique`},{layout:`spread`,tf:`4h`,candleMode:`default`},{layout:`overlap`,tf:`1d`,candleMode:`default`}],ue={NE:{rx:1,ry:-1,rz:1},NW:{rx:1,ry:1,rz:-1},SW:{rx:-1,ry:1,rz:1},SE:{rx:-1,ry:-1,rz:-1},N:{rx:1.2,ry:0,rz:0},S:{rx:-1.2,ry:0,rz:0},E:{rx:0,ry:-1.2,rz:0},W:{rx:0,ry:1.2,rz:0},CENTER:{rx:0,ry:0,rz:0}},D=0;function O(e=1){let t=T.compassCycle,n=ue[t[D%t.length]||`NE`]||ue.NE,r=Array.isArray(T.tiltAngle)?T.tiltAngle:[T.tiltAngle],i=r[D%r.length]??10;return`rotateX(${(n.rx*i).toFixed(1)}deg) rotateY(${(n.ry*i).toFixed(1)}deg) rotateZ(${(n.rz*(i/4)).toFixed(1)}deg) scale(${(T.scale*e).toFixed(3)})`}function de(e=1){return O(1.03*e)}function fe(){return`
    <style>
      #start-screen {
        position: fixed;
        inset: 0;
