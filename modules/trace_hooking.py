...
def apply_traces(manager_broadcast=None):
    ...
    exchange_api.fetch_exchange_market_data = phase_trace(1)(
        exchange_api.fetch_exchange_market_data
    )
    exchange_api.get_korean_exchange_markets = phase_trace(2)(
        exchange_api.get_korean_exchange_markets
    )
    exchange_api.fetch_binance_futures_spot = phase_trace(3)(
        exchange_api.fetch_binance_futures_spot
    )
    ...
    exchange_api.fetch_global_listings = phase_trace(7)(
        exchange_api.fetch_global_listings
    )
